...
## Objective
Implement COD and pluggable online payment architecture.
...
- [ ] COD lifecycle
- [ ] Payment/payment_attempt tables
- [ ] Webhook raw-body/signature pattern
- [ ] Webhook event deduplication
- [ ] Paid/failed transitions
- [ ] Full/partial refund records
- [ ] Payment admin detail
- [ ] Test provider/fake adapter
...
- [ ] Order/payment states remain separate
- [ ] Refund audited
...
`feat(payments): complete phase 12 payments`

Then ask:

> Phase 12 is complete. Do you want me to commit and push this phase to `https://github.com/workwithasim/food-website.git`?
