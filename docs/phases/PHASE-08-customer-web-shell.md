# Phase 08 — Customer Web Shell

## Objective
Build the original white-label responsive customer experience.
...
- [ ] Location/fulfillment selector
- [ ] Home banners/placeholder CMS integration
- [ ] Menu/category browsing
- [ ] Product cards
- [ ] Product detail customizer
- [ ] Authentication entry points
- [ ] Responsive/RTL-ready component primitives
...
## Acceptance Criteria
- [ ] No restaurant-specific hard-coded branding
- [ ] Mobile menu usable
- [ ] Required modifiers clearly represented
- [ ] Tenant custom domain loads correct theme
...
`feat(customer-web-shell): complete phase 08 customer web shell`

Then ask:

> Phase 08 is complete. Do you want me to commit and push this phase to `https://github.com/workwithasim/food-website.git`?
