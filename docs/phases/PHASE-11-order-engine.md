# Phase 11 — Order Engine

## Objective
Implement durable order creation, snapshots and state machine.
...
## Acceptance Criteria
- [ ] Duplicate idempotency key returns same logical order
- [ ] Invalid transitions denied
- [ ] Catalog edits do not alter old orders
- [ ] Order history tenant/customer scoped
...
`feat(order-engine): complete phase 11 order engine`

Then ask:

> Phase 11 is complete. Do you want me to commit and push this phase to `https://github.com/workwithasim/food-website.git`?
